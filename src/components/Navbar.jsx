...
<h1 className='w-full text-3xl font-bold primary-color ml-4 '>A. Sharma </h1>
...
<h1 className=' z-10 w-full text-3xl font-bold primary-color ml-4 '>A. Sharma </h1>
    ...
    <li className='p-2'><a href='#home' onClick={handleLinkClick} >Home</a></li>
        ...
        <li className='p-2'><a href='#education' onClick={handleLinkClick}>Education</a></li>
